...
export const metadata: Metadata = {
  ...
  description:
    'Find pest control companies in Birmingham. Browse residential and commercial pest control services across all Birmingham districts including Sutton Coldfield, Edgbaston, Erdington and more.',
  alternates: {
  ...
  openGraph: {
    title: 'Pest Control Birmingham | Find Local Experts',
    description:
      'Find pest control companies in Birmingham. Browse residential and commercial services across all Birmingham districts.',
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          >
            Find local pest control providers across Birmingham &amp; West Midlands
          </p>
          <p
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border-t-4 border-[#2563eb]">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Find pest control providers for your home across Birmingham and West Midlands.
