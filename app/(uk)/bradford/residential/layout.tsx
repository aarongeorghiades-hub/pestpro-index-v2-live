...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  // business_residential inside the bradford region. Head-only, so the
  ...
  const jsonLd = {
    ...
    description: `${countLead} in Bradford and West Yorkshire. Ratings, reviews, BPCA and NPTA certified companies.`,
