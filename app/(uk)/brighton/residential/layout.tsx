...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  // business_residential inside the brighton region. Head-only, so the
  ...
  const jsonLd = {
    ...
    description: `${countLead} across Brighton, Hove, Worthing, Eastbourne and Sussex. Ratings, reviews, BPCA and NPTA certified companies.`,
