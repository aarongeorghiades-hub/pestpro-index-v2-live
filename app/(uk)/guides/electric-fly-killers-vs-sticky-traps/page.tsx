...
export default function ElectricFlyKillersVsStickyTrapsPage() {
  return (
    ...
    >
      ...
      <p>
        For our picks, see our guide to the best <Link href="/best/fly-killer-indoor" className="text-[var(--color-ok)] hover:underline">indoor fly killers</Link>. If you need a unit for a commercial kitchen or food business, see our <Link href="/best/professional-insect-light-traps" className="text-[var(--color-ok)] hover:underline">commercial insect light traps</Link> guide.
      </p>
