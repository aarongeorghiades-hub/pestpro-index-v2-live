  ...
  return (
    ...
    >
      ...
      <div className="not-prose my-8 p-6 bg-[var(--color-teal-wash)] border border-[var(--color-teal-edge)] rounded-xl">
        <p className="font-bold text-[var(--color-ink)] mb-2">Looking for bed bug treatment products?</p>
        <p className="text-[var(--color-ink-soft)] mb-3">Our guide covers the best sprays, powders, and prevention products available in the UK.</p>
        <a
        ...
        >
          Best Bed Bug Treatment Products UK 2026
        </a>
      </div>
      ...
      <div className="not-prose my-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <span className="block text-sm text-[var(--color-ink-mute)] mt-1">Find bed bug specialists</span>
        </Link>
        <Link
