...
export default function HowToGetRidOfCockroachesPage() {
  return (
    ...
    >
      ...
      <p>
        The gel baits that clear a colony fastest &mdash; <strong>Advion Cockroach Gel</strong> (active ingredient: indoxacarb) and <strong>Goliath Gel</strong> (active ingredient: fipronil) among them &mdash; are authorised for professional use only in the UK and are not sold to the general public. What you can buy is a consumer-grade gel bait, on general sale and needing no licence; it works on the same cascade principle but is a step down in strength and quantity, and suits a small problem caught early. Our <a href="/best/cockroach-gel-bait">best cockroach gel bait guide</a> sets out what is available. Whichever gel you use, apply tiny, <strong>rice-grain-sized dots</strong> of gel in the corners of kitchen cupboards, along the edges of worktops where they meet the wall, around pipe entry points under the sink, in the hinges of kitchen drawers and cabinets, behind and beneath the fridge and cooker, and in any other crevices near food and warmth. Do not apply large blobs &mdash; many small dots are far more effective than a few large deposits, because they create more feeding stations and increase the chances of cockroaches encountering the bait. Replace the gel every <strong>2 to 3 weeks</strong> as it dries out and loses its attractiveness.
      </p>
      ...
      <div className="not-prose my-8 p-6 bg-[var(--color-teal-wash)] border border-[var(--color-teal-edge)] rounded-xl">
        <p className="font-bold text-[var(--color-ink)] mb-2">Looking for cockroach control products?</p>
        <p className="text-[var(--color-ink-soft)] mb-3">Our guide covers the best gel baits, sprays, powders, and traps available in the UK.</p>
        <a
      ...
      <p>
        Use the links below to find cockroach control specialists in your area.
      </p>
      ...
      <div className="not-prose my-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <span className="block text-sm text-[var(--color-ink-mute)] mt-1">Find cockroach specialists</span>
        </Link>
        <Link
