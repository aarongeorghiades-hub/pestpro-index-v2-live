...
export default function HowToGetRidOfFleasPage() {
  return (
    ...
    >
      ...
      <p>
        For a detailed comparison of the most effective household flea products available in the UK, see our <Link href="/best/flea-treatments" className="text-[var(--color-teal-deep)] hover:underline font-medium">Best Flea Treatments UK 2026</Link> guide.
      </p>
      ...
      <div className="not-prose my-8 p-6 bg-[var(--color-teal-wash)] border border-[var(--color-teal-edge)] rounded-xl">
        <p className="font-bold text-[var(--color-ink)] mb-2">Looking for flea treatment products?</p>
        <p className="text-[var(--color-ink-soft)] mb-3">Our guide covers the best household sprays, foggers, and flea treatments available in the UK.</p>
        <a
      ...
      <div className="not-prose my-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <span className="block text-sm text-[var(--color-ink-mute)] mt-1">Find flea specialists</span>
        </Link>
        <Link
