...
export default function HowToGetRidOfMothsPage() {
  return (
    ...
    >
      ...
      <p>
        For a detailed comparison of the most effective moth control products available in the UK, including hanging moth killers, pheromone traps, carpet sprays, and sachets, see our <Link href="/best/moth-killers" className="text-[var(--color-teal-deep)] hover:underline font-medium">Best Moth Killers UK 2026</Link> guide.
      </p>
      ...
      <div className="not-prose my-8 p-6 bg-[var(--color-teal-wash)] border border-[var(--color-teal-edge)] rounded-xl">
        <p className="font-bold text-[var(--color-ink)] mb-2">Looking for moth killer products?</p>
        <p className="text-[var(--color-ink-soft)] mb-3">Our guide covers the best moth killers, pheromone traps, sprays, and sachets available in the UK.</p>
        <a
      ...
      <p>
        For a complete breakdown of pest control costs across all common UK pests, see our <Link href="/guides/pest-control-costs" className="text-[var(--color-teal-deep)] hover:underline font-medium">Pest Control Costs UK 2026</Link> guide.
      </p>
      ...
      <div className="not-prose my-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <span className="block text-sm text-[var(--color-ink-mute)] mt-1">Find moth specialists</span>
        </Link>
        <Link
