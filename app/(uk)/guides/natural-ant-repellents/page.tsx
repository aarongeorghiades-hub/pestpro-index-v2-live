...
export default function NaturalAntRepellentsPage() {
  return (
    ...
    >
      ...
      <p>
        If you prefer ready-made solutions rather than mixing your own, these are the natural ant deterrent products we recommend, available in the UK. All of these are non-lethal repellents or natural treatments &mdash; no synthetic pesticides.
      </p>
