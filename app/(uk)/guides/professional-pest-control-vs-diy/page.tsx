  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>Ant gel bait:</strong> Gel bait is the right approach for ants, and it is what professionals use too &mdash; though the gels they carry are not generally stocked by consumer retailers. If you are treating ants yourself, use a gel sold for home use. See our <Link href="/best/ant-gel-bait">best ant gel bait</Link> guide.</li>
