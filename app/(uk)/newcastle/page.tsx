...
export const metadata: Metadata = {
  ...
  description:
    'Find pest control companies in Newcastle upon Tyne and the North East. Compare BPCA-certified local specialists for rats, mice, wasps, bed bugs and more.',
  alternates: {
...
export default async function NewcastleHubPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does pest control cost in Newcastle upon Tyne?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pest control costs in Newcastle upon Tyne typically range from £80-£150 for a standard residential treatment such as mice or rats. Wasp nest removal usually costs £50-£80. Commercial pest control contracts vary depending on the size of premises and frequency of visits. Prices in Newcastle are generally comparable to other major Northern cities. Always get at least two quotes and check what is included in the price.',
        },
      },
      {
        '@type': 'Question',
        name: 'Are Newcastle pest controllers BPCA certified?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Many Newcastle upon Tyne pest control providers hold BPCA (British Pest Control Association) certification, which is a recognised industry standard. BPCA members must meet strict technical competence requirements, carry appropriate insurance, and follow a code of conduct. You can filter providers by BPCA certification on our residential and commercial directory pages to find accredited companies in the Newcastle area.',
        },
      },
      {
        '@type': 'Question',
        name: 'How quickly can I get a pest controller in Newcastle upon Tyne?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most Newcastle pest control companies offer same-day or next-day service for urgent issues such as wasp nests, rat infestations, or bed bugs. Several providers operate 24/7 emergency call-out services. For routine treatments and surveys, you can usually book within 2-3 working days. Response times may be faster in central Newcastle and slower in the more rural outlying areas such as Cramlington or Consett.',
        },
      },
    ],
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          >
            Find local pest control providers across Newcastle &amp; North East England
          </p>
          <p
      ...
      <section className="bg-gradient-to-r from-[#1e3a8a] to-[#2563eb] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-white">
            ...
            <div>
              <p className="text-4xl font-black">North East England</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border-t-4 border-[#2563eb]">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Find pest control providers for your home across Newcastle upon Tyne and the North East.
      ...
      <section className="relative bg-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Find pest control providers in your area of Newcastle upon Tyne. Select your area to see local providers and area-specific pest information.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4">
            {newcastleBoroughs.map((borough) => (
              <Link
                key={borough.slug}
                href={`/pest-control/newcastle/${borough.slug}`}
      ...
      <section className="relative bg-gradient-to-br from-gray-50 to-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-gray-900 mb-4">Common Pests in Newcastle upon Tyne</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Newcastle&apos;s mix of dense urban housing, riverside properties, and proximity to the Northumberland countryside creates varied pest pressures. Rats, mice, wasps, bed bugs, and pigeons are the most common call-outs across the North East.
            </p>
          </div>
