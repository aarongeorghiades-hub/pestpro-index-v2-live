...
export const glasgowBoroughs: GlasgowBoroughData[] = [
  {
    ...
    metaDescription: "Find pest control services in Glasgow City Centre covering Merchant City, Buchanan Street, Argyle Street, Blythswood Hill and Cowcaddens. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Glasgow West",
    slug: "glasgow-west",
    metaDescription: "Find pest control services in Glasgow West covering Byres Road, Hillhead, Kelvinbridge, Partick, Hyndland and Dowanhill. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Glasgow South",
    slug: "glasgow-south",
    metaDescription: "Find pest control services in Glasgow South covering Shawlands, Pollokshields, Govanhill, Queen's Park, Langside and Cathcart. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Glasgow East",
    slug: "glasgow-east",
    metaDescription: "Find pest control services in Glasgow East covering Dennistoun, Parkhead, Bridgeton, Calton, Tollcross and Shettleston. Compare providers with ratings and reviews.",
  ...
  },
  {
    ...
    metaDescription: "Find pest control services in East Dunbartonshire covering Bishopbriggs, Bearsden, Milngavie, Kirkintilloch, Lenzie and Lennoxtown. Compare providers with ratings and reviews.",
  ...
  },
  {
    ...
    metaDescription: "Find pest control services across Greater Glasgow covering Paisley, East Kilbride, Clydebank, Dumbarton, Hamilton and Motherwell. Compare providers with ratings and reviews.",
