  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <Link href={cityDirectoryHref('newcastle')} className="hover:text-blue-600">Newcastle</Link>
        <span className="mx-2">/</span>
      ...
      <section className="relative h-[400px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <p className="text-sm sm:text-base md:text-lg font-semibold max-w-2xl drop-shadow-lg" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.3)' }}>
            North East England &middot; No lead fees &middot; No commissions
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              All {providers.length} providers cover the Newcastle &amp; North East England area including {borough.name}
            </p>
          </div>
      ...
      <section className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-700 mb-4">
            ...
            {' | '}
            <Link href="/pest-control/north-east" className="text-blue-600 hover:underline font-semibold">
              North East Region
            </Link>
          </p>
        </div>
      ...
      <CityPestLinks citySlug="newcastle" cityName="Newcastle" />
    </div>
  );
}
