...
import type { NottinghamBoroughData } from '../nottingham-boroughs';
...
export default function NottinghamBoroughClient({ borough, initialProviders }: { borough: NottinghamBoroughData; initialProviders: Provider[] }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <Link href={cityDirectoryHref('nottingham')} className="hover:text-blue-600">Nottingham</Link>
        <span className="mx-2">/</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              All {providers.length} providers cover the East Midlands area including {borough.name}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-700 mb-4">
            <Link href="/nottingham/residential" className="text-blue-600 hover:underline font-semibold">
              ← Back to Nottingham Residential
            </Link>
            {' | '}
      ...
      <CityPestLinks citySlug="nottingham" cityName="Nottingham" />
    </div>
  );
}
