...
export const sheffieldBoroughs: SheffieldBoroughData[] = [
  {
    name: "Sheffield",
    slug: "sheffield",
    metaDescription: "Find pest control services in Sheffield covering Sheffield city centre, Sharrow, Nether Edge, Kelham Island, Broomhill, Crookes, Hillsborough, Ecclesall and surrounding areas. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Rotherham",
    slug: "rotherham",
    metaDescription: "Find pest control services in Rotherham covering Rotherham town centre, Wickersley, Maltby, the Dearne Valley corridor and surrounding areas. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Doncaster",
    slug: "doncaster",
    metaDescription: "Find pest control services in Doncaster covering Doncaster town centre, Bessacarr, Bentley, Armthorpe, Lakeside and surrounding areas. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Barnsley",
    slug: "barnsley",
    metaDescription: "Find pest control services in Barnsley covering Barnsley town centre, Penistone, Wombwell, Hoyland and the M1 corridor. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Chesterfield",
    slug: "chesterfield",
    metaDescription: "Find pest control services in Chesterfield covering Chesterfield town centre, Staveley, Dronfield and the Peak District fringe. Compare providers with ratings and reviews.",
