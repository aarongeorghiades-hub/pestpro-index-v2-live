...
const articleSchema = {
  ...
  description:
    "Our pick of the best flea foggers (flea bombs) available in the UK for 2026.",
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, flea foggers can be effective when used correctly as part of a comprehensive treatment plan. They work by filling a room with insecticidal mist or smoke that settles on surfaces and kills adult fleas. However, foggers alone are rarely sufficient — they should be combined with targeted spray treatment, thorough vacuuming, and pet treatment for best results. Foggers are best at reaching areas that spray cannot access, such as under heavy furniture and inside upholstered cushions.",
      },
    },
    {
      "@type": "Question",
      name: "How long do I need to leave the house after using a flea fogger?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "You must vacate the property for a minimum of 2-4 hours after activating a flea fogger, depending on the product. All people, pets (including fish, birds, and reptiles), and uncovered food must be removed before activation. After the required time, open all windows and doors to ventilate the property for at least 30 minutes before re-entering. Always follow the specific product instructions for exact timings.",
      },
    },
    {
      "@type": "Question",
      name: "How many flea foggers do I need?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Most flea foggers treat 15-40 cubic metres per unit — roughly equivalent to one average-sized room (3m x 4m x 2.5m = 30 cubic metres). You will need one fogger per room that is infested. For an average three-bedroom house with fleas in multiple rooms, expect to use 4-6 foggers. Always check the coverage area on the product label and use enough to treat your entire space adequately.",
      },
    },
    {
      "@type": "Question",
      name: "Should I vacuum before or after using a flea fogger?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Vacuum thoroughly before using a fogger — this removes flea eggs, larvae, and debris from carpet fibres, allowing the insecticide to penetrate deeper. After fogging, wait at least 24 hours before vacuuming to allow the insecticide to settle and work. Then vacuum daily for 2 weeks to stimulate flea pupae to hatch and expose them to the residual insecticide.",
      },
    },
    {
      "@type": "Question",
