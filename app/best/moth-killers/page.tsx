...
export default function BestMothKillersPage() {
  return (
    ...
    >
      ...
      <p>
        The sachets are infused with a subtle floral fragrance that keeps your stored clothing smelling fresh without the overwhelming chemical odour associated with traditional mothballs. This makes them particularly well-suited for use with delicate items such as cashmere scarves, silk ties, merino wool base layers, and baby clothes made from natural fibres. Each sachet provides protection for approximately three months, after which it should be replaced. Twenty sachets make it practical to protect every storage location in your home. One of the most common mistakes people make when dealing with a moth infestation is treating their wardrobe while ignoring the drawers, airing cupboard, and seasonal storage where moths may also be breeding. The Acana sachets eliminate this blind spot by making it quick, easy, and affordable to extend protection to every corner of your home where natural fibres are stored.
      </p>
      <p>
        <strong>Pros:</strong>
      </p>
      ...
      <ul>
        ...
        <li>Covers fewer wardrobes than the Acana four-pack for larger households</li>
      </ul>
      <p>
