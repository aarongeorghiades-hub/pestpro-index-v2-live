...
const faqSchema = {
  ...
  mainEntity: [
    { '@type': 'Question', name: 'Do professional bait stations work for mice as well as rats?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. All of the stations on this page accept both rat and mouse bait blocks. The entry holes are sized to allow mice and rats in while keeping children, pets, and non-target wildlife out. For mice-only infestations, you may prefer a smaller dedicated mouse bait station, but professional-grade boxes handle both species effectively.' } },
...
export default function ProfessionalBaitStationKitsPage() {
  return (
    ...
    >
      ...
      <p>
        Yes. All of the stations on this page accept both rat and mouse bait blocks. The entry holes are sized to allow mice and rats in while keeping children, pets, and non-target wildlife out. For mice-only infestations, a smaller dedicated mouse bait station may be more discreet, but professional-grade boxes handle both species effectively.
      </p>
