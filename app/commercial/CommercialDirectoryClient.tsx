...
// Filter categories — defined at module scope so the server-render state
// initializers below can reuse them without closure-ordering issues.
...
export default function CommercialDirectoryClient({ initialProviders }: { initialProviders: Provider[] }) {
  ...
  // Filter categories (defined at module scope as FILTER_CATEGORIES)
