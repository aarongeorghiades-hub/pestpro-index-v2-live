...
import { derbyBoroughs } from '@/app/pest-control/derby/derby-boroughs';
...
export const metadata: Metadata = {
  ...
  description:
    'Compare pest control companies in Derby.',
  alternates: {
...
export default async function DerbyHubPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does pest control cost in Derby?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pest control costs in Derby typically range from £80-£150 for a standard residential treatment such as mice or rats. Wasp nest removal usually costs £50-£80. Commercial pest control contracts vary depending on the size of premises and frequency of visits, with larger sites near Rolls-Royce, Toyota, and Pride Park often requiring tailored solutions. Prices in Derby are generally comparable to other major East Midlands cities. Always get at least two quotes and check what is included in the price.',
        },
      },
      {
        '@type': 'Question',
        name: 'Are Derby pest controllers BPCA certified?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Many Derby pest control providers hold BPCA (British Pest Control Association) certification, which is a recognised industry standard. BPCA members must meet strict technical competence requirements, carry appropriate insurance, and follow a code of conduct. You can filter providers by BPCA certification on our residential and commercial directory pages to find accredited companies in the Derby area.',
        },
      },
      {
        '@type': 'Question',
        name: 'How quickly can I get a pest controller in Derby?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most Derby pest control companies offer same-day or next-day service for urgent issues such as wasp nests, rat infestations, or bed bugs. Several providers operate 24/7 emergency call-out services. For routine treatments and surveys, you can usually book within 2-3 working days. Response times may be faster in central Derby around the Cathedral Quarter and slower in the more rural outlying areas such as Chellaston or Mickleover.',
        },
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-[#1e3a8a] to-[#2563eb] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-white">
            ...
            <div>
              <p className="text-4xl font-black">East Midlands</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border-t-4 border-[#2563eb]">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Find pest control providers for your home across Derby and Derbyshire.
                Filter by pest type, service features, and compare ratings from real customers.
              </p>
              <Link
                href="/derby/residential"
      ...
      <section className="relative bg-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Find pest control providers in your area of Derby. Select your area to see local providers and area-specific pest information.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4">
            {derbyBoroughs.map((borough) => (
              <Link
                key={borough.slug}
                href={`/pest-control/derby/${borough.slug}`}
      ...
      {/* COMMON PESTS IN DERBY */}
      <section className="relative bg-gradient-to-br from-gray-50 to-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-gray-900 mb-4">Common Pests in Derby</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Derby&apos;s mix of Victorian terraced housing, modern developments, the River Derwent corridor, and proximity to the Peak District and surrounding agricultural land creates varied pest pressures. Rats, mice, wasps, cockroaches, and bed bugs are the most common call-outs across the city.
            </p>
          </div>
