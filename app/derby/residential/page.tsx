...
export const metadata = cityDirectoryMetadata('Derby', 'derby');
...
export default async function ResidentialPage() {
  ...
  return (
    <>
      <ListingSchema
        providers={providers}
        listName={`Pest Control Providers in Derby`}
        listUrl="/derby/residential"
        areaName="Derby"
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Derby', url: '/derby/residential' },
        ]}
      />
