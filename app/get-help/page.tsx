...
export default function GetHelpPage() {
  ...
  const pestTypes = [
    'Mice', 'Rats', 'Bed Bugs', 'Wasps', 'Cockroaches', 'Ants',
    'Fleas', 'Moths', 'Pigeons', 'Birds', 'Squirrels', 'Flies',
    'Bees', 'Foxes', 'Spiders', 'Beetles', 'Other',
  ];
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative bg-gradient-to-br from-[#050812] via-[#1e3a8a] to-[#050812] py-24 text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white mb-6 drop-shadow-lg" style={{ textShadow: '0 4px 6px rgba(0,0,0,0.3)' }}>
              Request Received
            </h1>
            <p className="text-xl text-blue-100 font-semibold mb-8">
              Thank you, {name}! We&apos;ll be in touch shortly to connect you with a trusted pest control provider in your area.
            </p>
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-white text-blue-700 font-bold rounded-lg hover:bg-blue-50 transition-all"
            >
              Back to Home
            </Link>
          </div>
      ...
      <section className="relative bg-gradient-to-br from-[#050812] via-[#1e3a8a] to-[#050812] py-24 text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl text-blue-100 font-semibold drop-shadow" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>
            Tell us about your pest problem and we&apos;ll connect you with a trusted local provider.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-white to-blue-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <form onSubmit={handleSubmit} className="bg-white rounded-xl border-2 border-blue-200 p-8 shadow-md space-y-6">
            ...
            {/* Pest Type */}
            <div>
              <label htmlFor="pestType" className="block text-sm font-bold text-gray-900 mb-2">
                Type of Pest <span className="text-red-500">*</span>
              </label>
              <select
                id="pestType"
                required
            ...
            <fieldset className="space-y-4">
              ...
              {addressLookedUp && (
                <>
                  ...
                  {/* County - auto-populated (if available) */}
                  {county && (
                    <div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell us more about the pest issue (optional)"
              />
            </div>
