      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
          ...
          <p className="text-lg sm:text-xl md:text-3xl lg:text-4xl mb-6 font-extralight tracking-[0.15em] text-white drop-shadow-[0_8px_20px_rgba(0,0,0,0.9)]">
            {filteredProviders.length} Verified Providers in Glasgow & Scotland
          </p>
      ...
      <section className="relative bg-gradient-to-br from-yellow-50 to-white py-16 border-b-2 border-yellow-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Highest-rated commercial pest control providers in Glasgow & Scotland</p>
          </div>
      ...
      <section className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-700 mb-4">
            ...
            {' | '}
            <Link href="/liverpool/commercial" className="text-blue-600 hover:underline font-semibold">
            ...
            {' | '}
            <Link href="/nottingham/commercial" className="text-blue-600 hover:underline font-semibold">
              Nottingham Commercial
            </Link>
            {' | '}
            <Link href="/brighton/commercial" className="text-blue-600 hover:underline font-semibold">
              Brighton Commercial
            </Link>
            {' | '}
            <Link href="/sheffield/commercial" className="text-blue-600 hover:underline font-semibold">
              Sheffield Commercial
            </Link>
            {' | '}
            <Link href="/bristol/commercial" className="text-blue-600 hover:underline font-semibold">
              Bristol Commercial
            </Link>
          </p>
        </div>
