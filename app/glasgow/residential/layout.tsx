...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  // business_residential inside the glasgow region. Head-only, so the
  ...
  const jsonLd = {
    ...
    description: `${countLead} across Glasgow, the West End, Southside and Scotland. Ratings, reviews, BPCA and NPTA certified companies.`,
