          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              ...
              <td className="py-3 px-4">
                <a href="https://www.amazon.co.uk/s?k=steel+wool+pest+proofing&tag=pestproindex2-21" target="_blank" rel="sponsored nofollow noopener noreferrer" className="text-blue-600 hover:underline text-sm">View on Amazon</a>
              </td>
            </tr>
            <tr>
              ...
              <td className="py-3 px-4">
                <a href="https://www.amazon.co.uk/s?k=expanding+foam+exterior+grade&tag=pestproindex2-21" target="_blank" rel="sponsored nofollow noopener noreferrer" className="text-blue-600 hover:underline text-sm">View on Amazon</a>
              </td>
            </tr>
            <tr>
              ...
              <td className="py-3 px-4">
                <a href="https://www.amazon.co.uk/s?k=stainless+steel+mesh+3mm+pest&tag=pestproindex2-21" target="_blank" rel="sponsored nofollow noopener noreferrer" className="text-blue-600 hover:underline text-sm">View on Amazon</a>
              </td>
            </tr>
            <tr>
              ...
              <td className="py-3 px-4">
                <a href="https://www.amazon.co.uk/s?k=brush+strip+draught+excluder+door&tag=pestproindex2-21" target="_blank" rel="sponsored nofollow noopener noreferrer" className="text-blue-600 hover:underline text-sm">View on Amazon</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="py-3 px-4">
                <a href="https://www.amazon.co.uk/s?k=exterior+wood+preservative+shed&tag=pestproindex2-21" target="_blank" rel="sponsored nofollow noopener noreferrer" className="text-blue-600 hover:underline text-sm">View on Amazon</a>
              </td>
            </tr>
          </tbody>
        </table>
