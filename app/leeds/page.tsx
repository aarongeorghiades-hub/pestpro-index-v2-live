...
import { leedsBoroughs } from '@/app/pest-control/leeds/leeds-boroughs';
...
export const metadata: Metadata = {
  ...
  description:
    'Find pest control companies in Leeds. Browse residential and commercial services across all Leeds districts including Wakefield, Kirklees, Calderdale and more.',
  alternates: {
  ...
  openGraph: {
    title: 'Pest Control Leeds | Find Local Experts',
    description:
      'Find pest control companies in Leeds. Browse residential and commercial services across all Leeds districts.',
...
export default async function LeedsHubPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does pest control cost in Leeds?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pest control costs in Leeds typically range from £80-£150 for a standard residential treatment such as mice or rats. Wasp nest removal usually costs £50-£80. Commercial pest control contracts vary depending on the size of premises and frequency of visits. Prices in Leeds tend to be lower than London but comparable to other Northern cities. Always get at least two quotes and check what is included in the price.',
        },
      },
      {
        '@type': 'Question',
        name: 'Are Leeds pest controllers BPCA certified?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Many Leeds pest control providers hold BPCA (British Pest Control Association) certification, which is a recognised industry standard. BPCA members must meet strict technical competence requirements, carry appropriate insurance, and follow a code of conduct. You can filter providers by BPCA certification on our residential and commercial directory pages to find accredited companies in the Leeds area.',
        },
      },
      {
        '@type': 'Question',
        name: 'How quickly can I get a pest controller in Leeds?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most Leeds pest control companies offer same-day or next-day service for urgent issues such as wasp nests, rat infestations, or bed bugs. Several providers operate 24/7 emergency call-out services. For routine treatments and surveys, you can usually book within 2-3 working days. Response times may be faster in central Leeds and slower in the outlying areas of West Yorkshire.',
        },
      },
    ],
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          >
            Find local pest control providers across Leeds &amp; West Yorkshire
          </p>
          <p
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8 border-t-4 border-[#2563eb]">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Find pest control providers for your home across Leeds and West Yorkshire.
      ...
      <section className="relative bg-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Find pest control providers in your area of Leeds. Select your district to see local providers and area-specific pest information.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {leedsBoroughs.map((borough) => (
              <Link
                key={borough.slug}
                href={`/pest-control/leeds/${borough.slug}`}
      ...
      {/* COMMON PESTS IN LEEDS */}
      <section className="relative bg-gradient-to-br from-gray-50 to-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-gray-900 mb-4">Common Pests in Leeds</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Leeds&apos; mix of urban and suburban housing creates varied pest pressures. Rats and mice are the most common call-outs, particularly near the River Aire and in older terraced streets. Wasps are a significant summer pest, while foxes and bed bugs are growing concerns across the city.
            </p>
          </div>
