...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  // business_residential inside the leeds region. Head-only, so the
  ...
  const jsonLd = {
    ...
    description: `${countLead} in Leeds and West Yorkshire. Ratings, reviews, BPCA and NPTA certified companies.`,
