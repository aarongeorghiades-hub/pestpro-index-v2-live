...
import { leicesterBoroughs } from '@/lib/leicester-boroughs';
...
export default async function LeicesterHubPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does pest control cost in Leicester?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pest control costs in Leicester typically range from £80-£150 for a standard residential treatment such as mice or rats. Wasp nest removal usually costs £50-£80. Commercial pest control contracts vary depending on the size of premises and frequency of visits. Prices in Leicester are generally comparable to other major East Midlands cities. Always get at least two quotes and check what is included in the price.',
        },
      },
      {
        '@type': 'Question',
        name: 'Are Leicester pest controllers BPCA certified?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Many Leicester pest control providers hold BPCA (British Pest Control Association) certification, which is a recognised industry standard. BPCA members must meet strict technical competence requirements, carry appropriate insurance, and follow a code of conduct. You can filter providers by BPCA certification on our residential and commercial directory pages to find accredited companies in the Leicester area.',
        },
      },
      {
        '@type': 'Question',
        name: 'How quickly can I get a pest controller in Leicester?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most Leicester pest control companies offer same-day or next-day service for urgent issues such as wasp nests, rat infestations, or bed bugs. Several providers operate 24/7 emergency call-out services. For routine treatments and surveys, you can usually book within 2-3 working days. Response times may be faster in central Leicester and slower in the more rural outlying areas such as Oadby or Wigston.',
        },
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Find pest control providers in your area of Leicester. Select your area to see local providers and area-specific pest information.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4">
            {leicesterBoroughs.map((borough) => (
              <Link
                key={borough.slug}
                href={`/pest-control/leicester/${borough.slug}`}
      ...
      <section className="relative bg-gradient-to-br from-gray-50 to-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-gray-900 mb-4">Common Pests in Leicester</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Leicester&apos;s mix of Victorian terraced housing, modern developments, waterways along the River Soar and Grand Union Canal, and proximity to agricultural land creates varied pest pressures. Rats, mice, wasps, cockroaches, and bed bugs are the most common call-outs across the city.
            </p>
          </div>
