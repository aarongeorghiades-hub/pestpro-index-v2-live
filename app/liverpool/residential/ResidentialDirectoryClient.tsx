...
export default function ResidentialDirectoryClient({ initialProviders }: { initialProviders: Provider[] }) {
  ...
  const providersWithBorough = useMemo(() => {
    return providers.map(p => ({
      ...p,
      london_borough: p.address?.split(',').pop()?.trim() || 'Liverpool'
    }));
  }, [providers]);
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center text-white px-4">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-6 max-w-2xl drop-shadow-lg" style={{textShadow: '0 2px 4px rgba(0,0,0,0.3)'}}>
            {providers.length} Verified Providers in Liverpool & Merseyside
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Top pest control providers in Liverpool & Merseyside
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-gray-900 mb-4">
              Full List of Liverpool & Merseyside Pest Control Providers
            </h2>
      ...
      <section className="bg-gradient-to-br from-blue-50 to-white border-t-2 border-blue-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Browse Liverpool providers who specialise in specific pests</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
            <Link href="/pest-control/liverpool/rats" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🐀 Rats</Link>
            <Link href="/pest-control/liverpool/mice" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🐁 Mice</Link>
            <Link href="/pest-control/liverpool/wasps" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🐝 Wasps</Link>
            <Link href="/pest-control/liverpool/bed-bugs" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🛏️ Bed Bugs</Link>
            <Link href="/pest-control/liverpool/cockroaches" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🪳 Cockroaches</Link>
            <Link href="/pest-control/liverpool/ants" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🐜 Ants</Link>
            <Link href="/pest-control/liverpool/fleas" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🦟 Fleas</Link>
            <Link href="/pest-control/liverpool/foxes" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🦊 Foxes</Link>
            <Link href="/pest-control/liverpool/moths" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🦋 Moths</Link>
            <Link href="/pest-control/liverpool/pigeons" className="flex items-center justify-center gap-2 px-4 py-3 bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition-all font-semibold text-sm text-gray-800">🐦 Pigeons</Link>
          </div>
        </div>
      </section>
