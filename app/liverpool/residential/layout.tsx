...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  // business_residential inside the liverpool region. Head-only, so the
  ...
  const jsonLd = {
    ...
    description: `${countLead} in Liverpool and Merseyside. Ratings, reviews, BPCA and NPTA certified companies.`,
