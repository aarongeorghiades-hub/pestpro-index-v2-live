...
import { manchesterBoroughs } from '@/app/pest-control/manchester/manchester-boroughs';
...
export default async function ManchesterHubPage() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'How much does pest control cost in Manchester?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pest control costs in Manchester typically range from £80-£150 for a standard residential treatment such as mice or rats. Wasp nest removal usually costs £50-£80. Commercial pest control contracts vary depending on the size of premises and frequency of visits. Prices in Manchester tend to be lower than London but comparable to other major Northern cities. Always get at least two quotes and check what is included in the price.',
        },
      },
      {
        '@type': 'Question',
        name: 'Are Manchester pest controllers BPCA certified?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Many Manchester pest control providers hold BPCA (British Pest Control Association) certification, which is a recognised industry standard. BPCA members must meet strict technical competence requirements, carry appropriate insurance, and follow a code of conduct. You can filter providers by BPCA certification on our residential and commercial directory pages to find accredited companies in the Manchester area.',
        },
      },
      {
        '@type': 'Question',
        name: 'How quickly can I get a pest controller in Manchester?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most Manchester pest control companies offer same-day or next-day service for urgent issues such as wasp nests, rat infestations, or bed bugs. Several providers operate 24/7 emergency call-out services. For routine treatments and surveys, you can usually book within 2-3 working days. Response times may be faster in central Manchester and slower in the outlying boroughs of Greater Manchester.',
        },
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-[#1e3a8a] to-[#2563eb] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-white">
            ...
            <div>
              <p className="text-4xl font-black">{manchesterBoroughs.length}</p>
      ...
      <section className="relative bg-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Find pest control providers in your area of Manchester. Select your district to see local providers and area-specific pest information.
            </p>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {manchesterBoroughs.map((borough) => (
              <Link
                key={borough.slug}
                href={`/pest-control/manchester/${borough.slug}`}
      ...
      {/* COMMON PESTS IN MANCHESTER */}
      <section className="relative bg-gradient-to-br from-gray-50 to-white py-16 border-b-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-gray-900 mb-4">Common Pests in Manchester</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Manchester&apos;s dense urban environment creates ideal conditions for a range of pests. Rats and mice are the most common call-outs, thriving near the canal network and older drainage systems. Cockroaches and bed bugs are growing concerns in the city centre, while pigeons roost on commercial buildings across the conurbation.
            </p>
          </div>
