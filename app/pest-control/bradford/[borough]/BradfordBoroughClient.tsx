...
export default function BradfordBoroughClient({ borough, initialProviders }: { borough: BradfordBoroughData; initialProviders: Provider[] }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              All {providers.length} providers cover the Bradford & West Yorkshire area including {borough.name}
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-700 mb-4">
            <Link href="/bradford/residential" className="text-blue-600 hover:underline font-semibold">
              ← Back to Bradford Residential
            </Link>
            {' | '}
            <Link href="/bradford/commercial" className="text-blue-600 hover:underline font-semibold">
              Bradford Commercial
            </Link>
            {' | '}
