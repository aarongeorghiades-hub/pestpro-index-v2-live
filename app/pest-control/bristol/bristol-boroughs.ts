...
export const bristolBoroughs: BristolBoroughData[] = [
  {
    name: "Bristol",
    slug: "bristol",
    metaDescription: "Find trusted pest control services in Bristol covering the city centre, Clifton, Bedminster, Southville, Easton, St Pauls, Redland, Cotham and Bishopston. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Bath",
    slug: "bath",
    metaDescription: "Find trusted pest control services in Bath covering Bath city centre, Batheaston, Bathford, Combe Down and Weston. Compare providers with ratings and reviews.",
  ...
  },
  {
    ...
    metaDescription: "Find trusted pest control services in South Gloucestershire covering Bradley Stoke, Filton, Yate, Chipping Sodbury, Thornbury and Kingswood. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "North Somerset",
    slug: "north-somerset",
    metaDescription: "Find trusted pest control services in North Somerset covering Clevedon, Portishead, Nailsea, Long Ashton and Backwell. Compare providers with ratings and reviews.",
  ...
  },
  {
    ...
    metaDescription: "Find trusted pest control services in Weston-super-Mare covering Weston town centre, Worle, Axbridge, Cheddar and Burnham-on-Sea. Compare providers with ratings and reviews.",
