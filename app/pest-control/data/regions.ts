...
export const regions: Region[] = [
  {
    ...
    metaTitle: "Pest Control in Greater London | 389 Verified Providers",
  ...
  },
  {
    ...
    slug: "south-east",
    status: "live",
    description: "Find trusted pest control and pest removal providers across the South East. PestPro Index covers Brighton and Hampshire with 172 verified providers, with expansion to Kent, Surrey, and more coming soon.",
    metaTitle: "Pest Control in the South East | Brighton, Hampshire & Surrounding Areas",
    metaDescription: "Compare 172 pest control and pest removal providers across the South East. Covering Brighton and Hampshire with verified providers. No lead fees, no commissions.",
    cities: [
      {
  ...
  },
  {
    ...
    metaTitle: "Pest Control in the South West | 43 Verified Providers",
