...
import type { DerbyBoroughData } from '../derby-boroughs';
...
export default function DerbyBoroughClient({ borough, initialProviders }: { borough: DerbyBoroughData; initialProviders: Provider[] }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <Link href={cityDirectoryHref('derby')} className="hover:text-blue-600">Derby</Link>
        <span className="mx-2">/</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              All {providers.length} providers cover the Derby &amp; Derbyshire area including {borough.name}
            </p>
          </div>
      ...
      <section className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-700 mb-4">
            <Link href="/derby/residential" className="text-blue-600 hover:underline font-semibold">
              ← Back to Derby Residential
            </Link>
            {' | '}
            <Link href="/derby/commercial" className="text-blue-600 hover:underline font-semibold">
              Derby Commercial
            </Link>
            {' | '}
            <Link href="/pest-control/east-midlands" className="text-blue-600 hover:underline font-semibold">
      ...
      <CityPestLinks citySlug="derby" cityName="Derby" />
    </div>
  );
}
