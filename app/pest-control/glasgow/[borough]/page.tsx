...
import { getBoroughBySlug } from '../glasgow-boroughs';
...
const cityConfig = getLocationBySlug('glasgow')!;
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) return {};
  return {
    title: `Pest Control ${data.name} | Glasgow & Scotland`,
...
export default async function GlasgowBoroughPage({ params }: Props) {
  ...
  return (
    <>
      ...
      />
      <GlasgowBoroughClient borough={data} initialProviders={providers} />
    </>
  );
}
