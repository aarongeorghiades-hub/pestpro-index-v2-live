...
export const glasgowBoroughs: GlasgowBoroughData[] = [
  {
    ...
    metaDescription: "Find trusted pest control services in Glasgow City Centre covering Merchant City, Buchanan Street, Argyle Street, Blythswood Hill and Cowcaddens. Compare providers with ratings and reviews.",
