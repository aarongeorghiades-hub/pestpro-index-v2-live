  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <Link href={cityDirectoryHref('hampshire')} className="hover:text-blue-600">Hampshire</Link>
        <span className="mx-2">/</span>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-white border-b-2 border-blue-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border-l-4 border-[#1e3a8a]">
            <h2 className="text-2xl font-black text-gray-900 mb-4">Common Pests in {town.name}</h2>
            <p className="text-gray-700 leading-relaxed">{town.commonPests}</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-gray-700 mb-4">
            ...
            {' | '}
            <Link href="/pest-control/south-east" className="text-blue-600 hover:underline font-semibold">
              South East Region
            </Link>
          </p>
        </div>
      ...
      <CityPestLinks citySlug="hampshire" cityName="Hampshire" />
    </div>
  );
}
