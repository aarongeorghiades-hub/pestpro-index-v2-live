...
export const leedsBoroughs: LeedsBoroughData[] = [
  {
    ...
    slug: "leeds-city",
    metaDescription: "Find trusted pest control services in Leeds city centre, Headingley, Hyde Park, Chapeltown, Harehills, Roundhay and Moortown. Compare providers covering postcodes LS1-LS17.",
  ...
  },
  {
    name: "Wakefield",
    slug: "wakefield",
    metaDescription: "Find trusted pest control services in Wakefield, Pontefract, Castleford, Normanton, Ossett and Dewsbury. Compare providers covering postcodes WF1-WF17.",
  ...
  },
  {
    name: "Kirklees",
    slug: "kirklees",
    metaDescription: "Find trusted pest control services in Huddersfield, Dewsbury, Batley, Heckmondwike, Cleckheaton and Holmfirth. Compare providers covering postcodes HD1-HD9 and WF12-WF17.",
  ...
  },
  {
    name: "Calderdale",
    slug: "calderdale",
    metaDescription: "Find trusted pest control services in Halifax, Brighouse, Elland, Todmorden, Hebden Bridge and Sowerby Bridge. Compare providers covering postcodes HX1-HX7.",
