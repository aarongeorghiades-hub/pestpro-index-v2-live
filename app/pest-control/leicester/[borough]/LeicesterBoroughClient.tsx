...
import type { LeicesterBoroughData } from '../leicester-boroughs';
...
export default function LeicesterBoroughClient({ borough, initialProviders }: { borough: LeicesterBoroughData; initialProviders: Provider[] }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav aria-label="Breadcrumb" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 text-sm text-gray-500">
        ...
        <span className="mx-2">/</span>
        <Link href={cityDirectoryHref('leicester')} className="hover:text-blue-600">Leicester</Link>
        <span className="mx-2">/</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              All {providers.length} providers cover the Leicester &amp; Leicestershire area including {borough.name}
            </p>
          </div>
      ...
      <CityPestLinks citySlug="leicester" cityName="Leicester" />
    </div>
  );
}
