...
export const liverpoolBoroughs: LiverpoolBoroughData[] = [
  {
    name: "Liverpool City",
    slug: "liverpool-city",
    metaDescription: "Find trusted pest control services in Liverpool city centre and inner Liverpool, Merseyside. Compare providers with ratings and reviews. BPCA & NPTA certified companies.",
  ...
  },
  {
    name: "Wirral",
    slug: "wirral",
    metaDescription: "Find trusted pest control services in Wirral, Merseyside. Covering Birkenhead, Wallasey, Bebington and Neston. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Sefton",
    slug: "sefton",
    metaDescription: "Find trusted pest control services in Sefton, Merseyside. Covering Bootle, Crosby, Formby and Southport. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Knowsley",
    slug: "knowsley",
    metaDescription: "Find trusted pest control services in Knowsley, Merseyside. Covering Prescot, Huyton, Kirkby and Halewood. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "St Helens",
    slug: "st-helens",
    metaDescription: "Find trusted pest control services in St Helens and surrounding areas, Merseyside. Compare providers with ratings and reviews. BPCA & NPTA certified companies.",
  ...
  },
  {
    name: "Warrington",
    slug: "warrington",
    metaDescription: "Find trusted pest control services in Warrington and surrounding areas. Compare providers with ratings and reviews. BPCA & NPTA certified companies.",
