...
export const nottinghamBoroughs: NottinghamBoroughData[] = [
  {
    ...
    metaDescription: "Find trusted pest control services in Nottingham city centre, St Ann's, Sneinton, Bulwell, Bestwood, The Park, Lace Market and Hockley. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Gedling",
    slug: "gedling",
    metaDescription: "Find trusted pest control services in Gedling borough covering Arnold, Carlton, Mapperley, Netherfield, Colwick and Calverton. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Broxtowe",
    slug: "broxtowe",
    metaDescription: "Find trusted pest control services in Broxtowe covering Beeston, Stapleford, Kimberley, Eastwood, Chilwell and Attenborough. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Rushcliffe",
    slug: "rushcliffe",
    metaDescription: "Find trusted pest control services in Rushcliffe covering West Bridgford, Bingham, Radcliffe-on-Trent, Cotgrave, Keyworth and Ruddington. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Ashfield",
    slug: "ashfield",
    metaDescription: "Find trusted pest control services in Ashfield covering Kirkby-in-Ashfield, Hucknall, Sutton-in-Ashfield, Annesley and Selston. Compare providers with ratings and reviews.",
  ...
  },
  {
    name: "Mansfield",
    slug: "mansfield",
    metaDescription: "Find trusted pest control services in Mansfield covering Mansfield town centre, Mansfield Woodhouse, Forest Town, Rainworth and Clipstone. Compare providers with ratings and reviews.",
