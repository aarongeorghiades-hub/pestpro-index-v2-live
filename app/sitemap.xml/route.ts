...
export async function GET() {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/liverpool/residential`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/liverpool/commercial`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/bradford`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/bradford/residential`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/bradford/commercial`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/brighton`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/brighton/residential`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/brighton/commercial`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/bristol`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/bristol/residential`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/bristol/commercial`, changefreq: 'weekly', priority: '0.9' },
    ...
    { url: `${baseUrl}/liverpool`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/manchester`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/nottingham`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/nottingham/residential`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/nottingham/commercial`, changefreq: 'weekly', priority: '0.9' },
    ...
    { url: `${baseUrl}/hampshire`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/hampshire/residential`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/hampshire/commercial`, changefreq: 'weekly', priority: '0.9' },
    ...
    { url: `${baseUrl}/guides/how-to-get-rid-of-mice`, changefreq: 'weekly', priority: '0.8' },
    ...
    { url: `${baseUrl}/guides/how-to-get-rid-of-moths`, changefreq: 'weekly', priority: '0.8' },
    { url: `${baseUrl}/best/moth-killers`, changefreq: 'weekly', priority: '0.8' },
    { url: `${baseUrl}/guides/restaurant-pest-control`, changefreq: 'weekly', priority: '0.8' },
    { url: `${baseUrl}/best/commercial-fly-killers`, changefreq: 'weekly', priority: '0.8' },
    { url: `${baseUrl}/guides/commercial-pest-control`, changefreq: 'weekly', priority: '0.9' },
    { url: `${baseUrl}/guides/warehouse-pest-management`, changefreq: 'weekly', priority: '0.8' },
    { url: `${baseUrl}/best/commercial-rodent-bait-stations`, changefreq: 'weekly', priority: '0.8' },
  ...
  // Liverpool borough pages
  const liverpoolBoroughSlugs = [
    'liverpool-city', 'wirral', 'sefton', 'knowsley', 'st-helens', 'warrington'
  ]

  const liverpoolBoroughPages = liverpoolBoroughSlugs.map(slug => ({
    url: `${baseUrl}/pest-control/liverpool/${slug}`,
    changefreq: 'monthly',
    priority: '0.7',
  }))

  // Bradford borough pages
  const bradfordBoroughSlugs = [
    'bradford-city', 'shipley', 'bingley', 'keighley', 'ilkley',
    'manningham', 'thornton', 'queensbury', 'idle', 'baildon'
  ]

  const bradfordBoroughPages = bradfordBoroughSlugs.map(slug => ({
    url: `${baseUrl}/pest-control/bradford/${slug}`,
    changefreq: 'monthly',
    priority: '0.7',
  }))
  ...
  // Hampshire town pages
  const hampshireTownSlugs = [
    'basingstoke', 'southampton', 'portsmouth', 'alton', 'andover',
    'lymington', 'winchester', 'fleet', 'fareham', 'havant',
    'waterlooville', 'hook', 'farnham', 'farnborough', 'gosport',
    'bordon', 'romsey', 'eastleigh', 'ringwood', 'isle-of-wight'
  ]

  const hampshireTownPages = hampshireTownSlugs.map(slug => ({
    url: `${baseUrl}/pest-control/hampshire/${slug}`,
    changefreq: 'monthly',
    priority: '0.7',
  }))

  // Coventry borough pages
  const coventryBoroughSlugs = [
    'coventry-city-centre', 'earlsdon', 'tile-hill', 'canley',
    'foleshill', 'stoke', 'binley', 'coundon'
  ]

  const coventryBoroughPages = coventryBoroughSlugs.map(slug => ({
    url: `${baseUrl}/pest-control/coventry/${slug}`,
    changefreq: 'monthly',
    priority: '0.7',
  }))
