...
export default function ClusterFliesPage() {
  return (
    ...
    >
      ...
      <p>
        <strong>Seal, in summer.</strong> Penn State Extension calls mechanical exclusion the best
        method and specifies sealing cracks around windows, doors, siding, utility pipes, behind
        chimneys, and underneath the fascia. University of Kentucky Extension emphasizes exclusion
