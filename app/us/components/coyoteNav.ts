// The header nav for the coyote cluster.
//
...
// why the constants were inline — that S49 R15's file scope was the page and the
// hub — which the move discharges. Nothing was dropped in carrying it across.

export const COYOTE_HOME = '/us';

export const COYOTE_NAV = [{ title: 'Coyotes', href: '/us/coyotes' }];
