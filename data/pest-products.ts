...
export const topProductsByPest: Record<string, PestProduct[]> = {
  ...
  'mice': [
    {
      ...
      price: '£10',
      bestFor: 'Best Overall',
      features: ['Professional quality snap traps — 6-pack', 'Amazon Choice with 5,000+ reviews'],
    },
    {
  ...
  'ants': [
    ...
    },
    {
      ...
      features: ['6,400+ verified reviews on Amazon UK', 'Six bait stations for whole-house coverage'],
    },
    {
